...
>>> sw = Car()
>>> dir(sw)
['__class__', '__delattr__', '__dict__', '__doc__', '__format__', '__getattribute__', '__hash__', '__init__', '__module__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__', 'brand', 'name']
>>> sw.brand
'Maruthi'
>>> sw.name
'Swift'
...
Traceback (most recent call last):
  File "<pyshell#1191>", line 1, in <module>
    sw = Car()
TypeError: __init__() takes exactly 3 arguments (1 given)
>>> sw = Car('Swift','Maruti')
>>> Car.__init__(sw,'Swift','Maruti')
>>> class Car(object):
	def __init__(self, n , b):
		self.name = n
		self.brand = b
...
Traceback (most recent call last):
  File "<pyshell#1202>", line 1, in <module>
    al.drive()
AttributeError: 'Bus' object has no attribute 'drive'
>>> class Car(object):
	def __init__(self, n , b):
		self.name = n
		self.brand = b
...
Traceback (most recent call last):
  File "<pyshell#1206>", line 1, in <module>
    sw.drive()
TypeError: drive() takes no arguments (1 given)
>>> class Car(object):
	def __init__(self, n , b):
		self.name = n
		self.brand = b
...
Traceback (most recent call last):
  File "<pyshell#1211>", line 1, in <module>
    Car.drive(sw)
TypeError: unbound method drive() must be called with Car instance as first argument (got Car instance instead)
>>> class Car(object):
	def __init__(self, n , b):
		self.name = n
		self.brand = b
...
>>> class Car(object):
	def __init__(self, n , b):
		...
		self.brand = b
	def drive(self):
		print "I am",self.name," and I drive"
...
Traceback (most recent call last):
  File "<pyshell#1225>", line 1, in <module>
    l[3]
IndexError: list index out of range
>>> raise ValueError('Insufficient Balance')

Traceback (most recent call last):
  File "<pyshell#1226>", line 1, in <module>
    raise ValueError('Insufficient Balance')
...
>>> a == 11
True
>>> assert a == 11, 'Was expecting 11'
>>> assert a == 10 , 'Was expecting 10'

Traceback (most recent call last):
  File "<pyshell#1255>", line 1, in <module>
    assert a == 10 , 'Was expecting 10'
AssertionError: Was expecting 10
>>> assert a > 10 , 'Was expecting 10'
...
Traceback (most recent call last):
  File "<pyshell#1260>", line 1, in <module>
    sp.popen('dir')
AttributeError: 'module' object has no attribute 'popen'
>>> sp.Popen
<class 'subprocess.Popen'>
>>> sp.Popen('dir')
<subprocess.Popen object at 0x0000000003755748>
>>> fh = open('myfile.txt','wt')
>>> sp.Popen('dir', stdout = fh)
<subprocess.Popen object at 0x0000000003755710>
>>> fh.close()
>>> sp.Popen('dir', shell=True, stdout = fh)

Traceback (most recent call last):
  File "<pyshell#1266>", line 1, in <module>
    sp.Popen('dir', shell=True, stdout = fh)
  File "D:\sw\Python27\lib\subprocess.py", line 703, in __init__
    errread, errwrite), to_close = self._get_handles(stdin, stdout, stderr)
  File "D:\sw\Python27\lib\subprocess.py", line 850, in _get_handles
    c2pwrite = msvcrt.get_osfhandle(stdout.fileno())
ValueError: I/O operation on closed file
>>> fh = open('myfile.txt','wt')
>>> sp.Popen('dir', shell=True, stdout = fh)
<subprocess.Popen object at 0x00000000037E46A0>
>>> fh.close()
>>> 
>>> with open('myfile.txt','wt') as fh:
	sp.Popen('dir', shell=True, stdout = fh)

	
<subprocess.Popen object at 0x0000000003755710>
>>> with open('myfile.txt','wt') as fh:
	sp.Popen('del a.txt', shell=True, stdout = fh)

	
<subprocess.Popen object at 0x00000000037E4630>
>>> with open('myfile.txt','wt') as fh:
	sp.Popen('del a.txt', shell=True, stdout = fh, stderr = fh)

	
<subprocess.Popen object at 0x0000000003755710>
>>> with open('myfile.txt','at') as fh:
	sp.Popen('del a.txt', shell=True, stdout = fh, stderr = fh)

	
<subprocess.Popen object at 0x00000000037E45F8>
>>> with open('myfile.txt','at') as fh:
	sp.Popen('del a.txt', shell=True, stdout = fh, stderr = fh)

	
<subprocess.Popen object at 0x0000000003755710>
>>> sp.Popen('del a.txt', shell=True, stdout = sp.PIPE, stderr = sp.PIPE)
<subprocess.Popen object at 0x00000000037E46A0>
>>> p = sp.Popen('del a.txt', shell=True, stdout = sp.PIPE, stderr = sp.PIPE)
>>> p.communicate()
('', 'Could Not Find D:\\sw\\Python27\\a.txt\r\n')
>>> p = sp.Popen('del a.txt', shell=True, stdout = sp.PIPE, stderr = sp.PIPE)
...
'Could Not Find D:\\sw\\Python27\\a.txt\r\n'
>>> import requests
>>> r = requests.get(r'https://www.omdbapi.com/?s=batman&apikey=b4e17ea0')
>>> r.status_code
200
>>> r.content[:200]
'{"Search":[{"Title":"Batman Begins","Year":"2005","imdbID":"tt0372784","Type":"movie","Poster":"https://images-na.ssl-images-amazon.com/images/M/MV5BYzc4ODgyZmYtMGFkZC00NGQyLWJiMDItMmFmNjJiZjcxYzVmXkE'
>>> 
>>> 
>>> 
>>> l = [['hello','one','two'],['hello','one','two'],['hello','one','two']]
>>> l1 = [ "".join(x) for x in l]
>>> l1
['helloonetwo', 'helloonetwo', 'helloonetwo']
>>> l2 = [ "".join(x) for x in l1]
>>> l2
['helloonetwo', 'helloonetwo', 'helloonetwo']
>>> "".join(l2)
'helloonetwohelloonetwohelloonetwo'
>>> 
